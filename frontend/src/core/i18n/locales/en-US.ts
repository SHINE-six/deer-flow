...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to Power-flow, an open source super agent. With built-in and custom skills, Power-flow helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Power-flow. With customized skills,\nPower-flow can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
